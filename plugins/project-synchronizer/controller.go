...
func (c *Controller) Run(ctx context.Context, workers int) error {
	...
	log.Println("starting project-synchronizer controller")
	...
	log.Printf("project-synchronizer controller started with %d worker(s)", workers)
	<-ctx.Done()
	log.Println("shutting down project-synchronizer controller")
	return nil
}
